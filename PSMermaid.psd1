#
# Module manifest for module 'PSMermaid'
#
# Generated by: Christian Ritter
#
# Generated on: 9/9/2023
#
...
@{
    ...
    GUID = 'd16d5345-183a-423d-802f-90769131b0a0'
    
    # Author of this module
    Author = 'Christian Ritter'
    
    # Company or vendor of this module
    CompanyName = 'Christian Ritter'
    
    # Copyright statement for this module
    Copyright = '(c) Christian Ritter. All rights reserved.'
    
    # Description of the functionality provided by this module
    Description = 'Easily Create Mermaid Markdown Files in PowerShell'
    ...
    FunctionsToExport = @(
        ...
        'New-MermaidERDiagram'
        'New-MermaidERDiagramEntity'
        'New-MermaidERDiagramEntityAttribute'
        'New-MermaidERDiagramRelationShip'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('MarkDown','Mermaid','Wrapper','Diagram','UML')
    
            # A URL to the license for this module.
            # LicenseUri = ''
    
            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/HCRitter/PSMermaid'
